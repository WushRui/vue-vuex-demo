    ...
    <div class="user-center">
        ...
        <div class>
            ...
            <section class="vip-list">
                <ul class="container">
                    <li class="list-item" v-for="(item,index) in vipList" :key="index">
...
<script>
    ...
    export default {
        ...
        methods:{
            buy(item){
                this.$store.dispatch('buyVip',item).then(res=>{
                    alert(res)
                })
            }
        }
...
<style scoped>
    ...
    .user-center .user-info .user-info-label,.user-info-value{
        flex: 0 0 auto;
    }
    .user-center .user-info:last-child {
        border-bottom: none;
    }
    ...
    .user-center .container .list-item {
        flex: 1;
        width: 100%;
        padding: 10px;
        text-align: left;
    ...
    .user-center .container .list-item .item-name {
        display: block;
        width: 100%;
        color: #ffe5db;
    }
    .user-center .container .list-item .item-content {
        display: flex;
        width: 100%;
        justify-content: space-between;
        align-items: center;
    ...
    .user-center .container .list-item .item-content .item-content__price {
         flex: 1;
         color: rgb(255, 153, 0);
         font-size: 22px;
    }
    .user-center .container .list-item .item-content .item-content__price .item-content__date{
        font-size: 14px;
        color: #ffe5db;
    }
    .item-content__btn{
